...
def make_lungmask(img, display=False):
    ...
    kmeans = KMeans(n_clusters=2, n_init=11).fit(np.reshape(middle, [np.prod(middle.shape), 1]))
...
output_path = "D:/hien_code/project_tinh_toan_song_song/output_folder/"
...
'''
    ...
    # make_lungmask(imgs_after_resamp[220], display='True')
